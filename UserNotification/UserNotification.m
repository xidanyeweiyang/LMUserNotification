...
- (void)addNotificationWithLocationTrigger
{
    ...
    content.subtitle = @"subtitle";
    content.body = @"这是一条'指定位置推送',请注意查收,谢谢";
    content.sound = [UNNotificationSound defaultSound];
    
    /*重点开始*/
    CLLocationCoordinate2D cen = CLLocationCoordinate2DMake(116.307689,40.056974);
    CLRegion *region = [[CLCircularRegion alloc] initWithCenter:cen radius:1000000 identifier:@"center"];
